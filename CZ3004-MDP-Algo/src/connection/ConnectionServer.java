...
public class ConnectionServer {
	...
	public void startServer() {
        ...
        try
        { 
            InetAddress ipAddress = InetAddress.getByName(Constant.IP_ADDRESS);
            System.out.println(ipAddress);
            server = new ServerSocket(Constant.PORT); 
            
            System.out.println("Server started on IP Address " + Constant.IP_ADDRESS + " and Port: " + Constant.PORT); 
