...
public class Constant {
	...
	public static final int BOARDWIDTH = 15; // By default, this should be 15. This must be greater than 3 as the Robot
												// assumes to take 3x3 grid.
	public static final int BOARDHEIGHT = 20; // By default, this should be 20. This must be greater than 3 as the Robot
												// assumes to take 3x3 grid.
	...
	public static final double[][] SENSOR_RANGES = { { 13.54, 21.46 }, { 10.0, 19.35 }, { 12, 21.555 }, { 12.85, 22.7 },
			{ 13.65, 25.25 }, { 19.4, 24.8, 32.15, 43, 51.75, 62.0 } };
